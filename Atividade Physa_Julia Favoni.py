...
def simular_jogo(
        prob_sobe_escada=1.0, 
        registrar_quedas=False, 
        contar_lancamentos=False, 
        pos_inicial_bruno=1, 
        imunidade_primeira_serpente=False
    ):
    ...
    quedas_serpentes = 0
    total_lancamentos = 0
    imunidade_bruno = imunidade_primeira_serpente 
    # True se Bruno tem uma cobra de imunidade
...
# Observações
print("\n----- Observações -----")
print(f"Os resultados podem variar com o número de simulações, um exemplo disso é a")
print(f"diferença entre a porcentagem de vitórias de Ana e Bruno na atividade 1 e ") 
print(f"na atividade 4 (quando Bruno está na primeira posição), devido a aleatoriedade")
print(f"natural das simulações.")